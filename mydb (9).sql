...
--
-- Hôte : localhost
-- Généré le : mer. 01 mai 2024 à 00:16
...
(67, 'Merbouche', 'Mouloud', 'mouloudmerb@mail.com', '$2y$10$.5mQ3KqXRjnLQOCxHnt3QegVqpmh8XHJpZUKKYXl1ffKpgZpesIWW', NULL, '', '2024-05-01', 0);
...
--
ALTER TABLE `Utilisateur`
  MODIFY `idUtilisateur` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
