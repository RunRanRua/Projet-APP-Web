...
--
-- Hôte : localhost
-- Généré le : ven. 31 mai 2024 à 09:22
...
CREATE TABLE `Billet_achete` (
  ...
  `Prix_billet` decimal(10,2) DEFAULT 0.00
...
INSERT INTO `Billet_achete` (`idBillet`, `idUtilisateur`, `idConcert`, `Date_achat_billet`, `Quantite`, `Prix_billet`) VALUES
(1, 85, 21, '2024-05-08', 1, 0.00);
...
INSERT INTO `Concert` (`idConcert`, `Titre`, `Date_concert`, `Duree`, `Description`, `Categorie`, `Etat`, `Like`, `ImagePath`, `Prix`) VALUES
(21, 'Beatles', '2024-05-01', NULL, 'Concert qui termine aux alentours de 18h00', NULL, NULL, NULL, 'concert1.jpg', 20.00),
(26, 'Rolling stone', '2024-05-02', NULL, 'Concerts', NULL, NULL, NULL, 'concert5.jpg', 20.00),
(27, 'Concert de RIhanna', '2024-05-01', NULL, 'Durée : 1H30\r\n', NULL, NULL, NULL, 'concert6.jpg', 50.00),
(28, 'COncer', '2024-05-03', NULL, 'ddd', NULL, NULL, NULL, 'concert2.jpg', 190.00);
...
ALTER TABLE `Billet_achete`
  ...
  ADD KEY `idx_Billet_achete_idUtilisateur` (`idUtilisateur`),
  ADD KEY `idx_Billet_achete_idConcert` (`idConcert`);
...
--
ALTER TABLE `Concert`
  MODIFY `idConcert` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
-- Contraintes pour la table `Billet_achete`
--
ALTER TABLE `Billet_achete`
  ADD CONSTRAINT `fk_Billet_achete_Concert` FOREIGN KEY (`idConcert`) REFERENCES `Concert` (`idConcert`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_Billet_achete_Utilisateur` FOREIGN KEY (`idUtilisateur`) REFERENCES `Utilisateur` (`idUtilisateur`) ON DELETE CASCADE ON UPDATE CASCADE;
